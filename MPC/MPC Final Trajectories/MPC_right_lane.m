...
% working with just the last piece from x~875 , idx = 11300
...
u_right = load('U_rightlane.mat');
u_right = u_right.U;
u = interp1(linspace(0,200,length(u_right)),u_right,T)';
x_right = load('Trajectory_rightlane.mat');
x_right = x_right.x;
x = interp1(linspace(0,200,length(x_right)),x_right,T)';
